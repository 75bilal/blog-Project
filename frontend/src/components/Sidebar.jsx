...
<div className='hidden sm:flex w-20 h-screen bg-[#1f1f1f] border-r border-gray-700 fixed top-0 left-0 flex-col items-center py-6 text-white'>
      ...
      <div className='flex flex-col pt-12 gap-12 text-2xl items-center'>
        <RiHome4Fill className='cursor-pointer hover:text-indigo-400' />
        <MdOutlineSubscriptions className='cursor-pointer hover:text-indigo-400' />
        <IoChatbox className='cursor-pointer hover:text-indigo-400' />
        <IoSearch className='cursor-pointer hover:text-indigo-400' />
      </div>
